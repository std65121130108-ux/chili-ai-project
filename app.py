...
# 1. กำหนด URL (ใส่ภาษาไทยได้เลย เดี๋ยว Python แปลงให้)
base_url = "http://www.cedubru.com/"
path = "ตรวจโรคผักชีฝรั่ง/"
# แปลงภาษาไทยเป็นรหัส (เช่น %E0%B8...) เพื่อกันลิงก์เสีย
full_url = base_url + urllib.parse.quote(path)

# 2. สร้าง HTML (สังเกต target="_top")
st.markdown(f"""
    <div style="text-align: center; margin-top: 30px; margin-bottom: 20px;">
        <a href="{full_url}" target="_top" class="custom-home-btn">
